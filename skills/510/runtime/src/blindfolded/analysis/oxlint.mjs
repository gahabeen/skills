...
import { typedCoverage } from "./typed-coverage.mjs";
...
export async function oxlint(project, directory, prepared) {
  ...
  for (const group of groups) {
    try {
      ...
      // Coverage survives a malformed diagnostics envelope.
      if (group.path) coverage.push(typedCoverage(result.stderr, project, group, gaps));
