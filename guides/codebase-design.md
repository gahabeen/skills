...
Read the shared [coding rules](coding-rules.md) for changed code. They own purpose
comments, data contracts, trust boundaries, helper ownership, and consumer checks.
