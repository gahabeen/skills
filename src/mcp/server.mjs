...
export async function serve(root) {
  ...
  tool("guide", "Read a 510 workflow or supporting guide: commit, handoff, grill, spec, implement, TDD, debug, design, review, refactoring, or storage/toolchain guidance. Returns instructions; the agent performs the workflow.", { topic: z.enum(topics) }, true, ({ topic }) => readGuide(topic));
