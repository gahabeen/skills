...
tester.run("blindfolded/require-readable-spacing", requireReadableSpacingRule, {
  valid: [
    "import { a } from 'a';\nimport { b } from 'b';\n\nexport const c = a + b;",
    "function f() {\nconst a = 1;\nconst b = 2;\n\nreturn a + b;\n}",
    "function f() { return 1; }",
  ...
  invalid: [
    ...
    {
      code: "const f = runGenerator(function* () {\nconst a = yield* A;\nconst b = yield* B;\nconst dispatch = nameGenerator('dispatch')(function* () {\nyield* a;\n});\nreturn dispatch;\n});",
      output:
        "const f = runGenerator(function* () {\nconst a = yield* A;\nconst b = yield* B;\n\nconst dispatch = nameGenerator('dispatch')(function* () {\nyield* a;\n});\n\nreturn dispatch;\n});",
      errors: [error, error],
    },
