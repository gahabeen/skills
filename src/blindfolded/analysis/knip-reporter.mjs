...
export default function report({ issues, report: enabled, configurationHints, tagHints, hasConfigLoadErrors, counters, enabledPlugins }) {
  const findings = [];
  ...
  process.stdout.write(JSON.stringify({ findings, configurationHints, tagHints: [...tagHints], hasConfigLoadErrors, counters, enabledPlugins }));
}
